...
public class LevelConfigurationReader {
    ...
    private static final int TICKS_PER_SECOND = 30;  // Assuming 30 ticks per second
    ...
    /**
     * Retrieves the lengths of the ghost modes in seconds, converting from ticks if necessary
     *
